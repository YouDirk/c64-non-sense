...
AAAssets_anim_chartop_runright[AAASSETS_ANIM_CHARTOP_RUNRIGHT_COUNT] = {
  ...
  },
  {
    {{_(____,____),_(____,____),_(____,____)},
     ...
     {_(____,____),_(____,DDDD),_(DDDD,iiDD)},
     {_(____,____),_(____,DDDD),_(DDDD,DDDD)},
     {_(____,____),_(____,DDDD),_(ggDD,ggDD)},
     {_(____,____),_(____,__DD),_(DDgg,gg__)},
     {_(____,____),_(____,__DD),_(DD__,gg__)},
     {_(____,____),_(ii__,__DD),_(DD__,____)},
     {_(__DD,iiii),_(iiii,iiii),_(ii__,iiDD)},
     {_(__DD,iiii),_(iiii,iiii),_(iiii,iiDD)},
     {_(____,iiii),_(iiii,iiii),_(iiii,ii__)},
     {_(____,____),_(iiii,iiii),_(ii__,____)},
     {_(____,____),_(iiii,iiii),_(ii__,____)},
     {_(____,____),_(iiii,iiii),_(ii__,____)},
     {_(____,__DD),_(iiii,iiii),_(____,____)},
     {_(____,__DD),_(DDii,iiii),_(____,____)},
     {_(____,gggg),_(DDDD,ii__),_(____,____)},
     {_(____,gggg),_(ggDD,DD__),_(____,____)},
     {_(__gg,gggg),_(gggg,DD__),_(____,ggii)}},
    7
  },
};
...
AAAssets_anim_charbot_runright[AAASSETS_ANIM_CHARBOT_RUNRIGHT_COUNT] = {
  ...
  {
    {{_(__DD,gggg),_(gggg,gggg),_(gg__,DDii)},
     {_(iiDD,gggg),_(gggg,gggg),_(gggg,DDii)},
     {_(iiDD,gg__),_(__gg,gggg),_(gggg,DDii)},
     {_(iiDD,____),_(____,gggg),_(gggg,DDii)},
     {_(iiDD,____),_(____,____),_(____,____)},
     {_(iiDD,____),_(____,____),_(____,____)},
     {_(____,____),_(____,____),_(____,____)},
     {_(____,____),_(____,____),_(____,____)},
     {_(____,____),_(____,____),_(____,____)},
